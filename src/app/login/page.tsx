...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between" style={{ height: '100vh' }}>
...
<div className="hidden w-full md:flex md:w-auto mt-8 z-50 absolute top-2 items-center" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:border-gray-700">
        ...
        <li>
          <a href="#" className="block py-2 px-3 text-2xl rounded md:hover:bg-transparent md:border-0 md:p-0 text-white dark:hover:text-[#333] md:dark:hover:bg-transparent">Login</a>
        </li>
        <li>
    ...
    <WavyBackground className="w-1/2 h-full absolute" />
